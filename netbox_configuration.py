...
DATABASE = {
    'NAME': environ.get('POSTGRES_DB', 'netbox'),       # Database name
    'USER': environ.get('POSTGRES_USER', ''),             # PostgreSQL username
    'PASSWORD': _read_secret('db_password', environ.get('POSTGRES_PASSWORD', '')),
                                                    # PostgreSQL password
    'HOST': environ.get('POSTGRES_HOST', 'postgres'),    # Database server
    'PORT': environ.get('DB_PORT', '5432'),             # Database port (leave blank for default)
